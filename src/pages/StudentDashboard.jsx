      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="bg-white shadow-md p-4 flex items-center justify-between lg:justify-start">
          ...
          <div className="flex items-center justify-center flex-1">
            ...
            <span className="text-3xl font-bold text-gray-800">Student Dashboard</span>
        ...
        <main className="flex-1 p-6">
          <div className="bg-white rounded-lg shadow-lg p-8">
            <h2 className="text-2xl font-semibold text-gray-800 mb-6">Welcome, Student!</h2>
            <p className="text-gray-600">This is your student dashboard. Here you can view your courses, schedule, and grades.</p>
